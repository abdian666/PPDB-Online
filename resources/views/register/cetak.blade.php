              ...
              <div class="row">
                <div class="col-6">
                    <div class="row">
                        ...
                        <div class="col-6">{{$model->nama_lengkap}}</div>
                        <div class="col-6">Jenis Kelamin</div>
                        <div class="col-6">{{$model->jk}}</div>
                        <div class="col-6">Agama</div>
                        <div class="col-6">{{$model->agama}}</div>
                        <div class="col-6">Alamat</div>
                        <div class="col-6">{{$model->alamat}}</div>
                        <div class="col-6">Asal SMP</div>
                        <div class="col-6">{{$model->asal_smp}}</div>
                        <div class="col-6">Jurusan</div>
                        <div class="col-6">{{$model->jurusan}}</div>
                    </div>
                </div>
            </div>
            </div>
